internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine("Calculate: {0} number2<0?-:+ {1} = {2}", number1, number2, MultiplicationNumbers(number1, number2));
    ...
    public static float MultiplicationNumbers(float number1, float number2)
    {
